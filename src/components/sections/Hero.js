        ...
        <div className={innerClasses}>
          <div className="hero-content">
            <h1 className="mt-0 mb-16 reveal-from-bottom" data-reveal-delay="200">
              The <span className="text-color-primary">movie recommender</span> bot <br /> for Discord
            </h1>
            <div className="container-xs">
              <p className="m-0 mb-32 reveal-from-bottom" data-reveal-delay="400">
                The only bot you need to track your own movie ratings and give you the best movie recommendation according to you own personal tastes
                </p>
          ...
          <div className="hero-figure reveal-from-bottom illustration-element-01" data-reveal-value="20px" data-reveal-delay="800">
            ...
            >
              <Image
                ...
                src={require('./../../assets/images/video-placeholder-movieBot2.png')}
                alt="Hero"
                width={896}
                height={504} />
            </a>
